...
\begin{figure}[H]
    ...
    \label{fig:jump_var_convergence}
\end{figure}
...
primarily reduces estimation error per query. In the real-world extension, gold
provides a stress-test for tail risk and still exhibits the same scaling signature
seen in the Gaussian toy model.
