...
Figures~\ref{fig:real_world_gold_fit} and~\ref{fig:real_world_spx_fit} show the fitted
double-Poisson model against empirical returns. Figures~\ref{fig:real_world_convergence}
and~\ref{fig:real_world_error_scaling} summarize classical convergence and scaling for
both assets.

\begin{figure}[ht]
    \centering
    \includegraphics[width=1\linewidth]{real_world_gold_fit.png}
    \caption{Gold returns vs fitted double-Poisson model.}
    \label{fig:real_world_gold_fit}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=1\linewidth]{real_world_spx_fit.png}
    \caption{S\&P 500 returns vs fitted double-Poisson model.}
    \label{fig:real_world_spx_fit}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=1\linewidth]{real_world_convergence.png}
    \caption{Monte Carlo VaR convergence on real-world fitted curves.}
    \label{fig:real_world_convergence}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=1\linewidth]{real_world_error_scaling.png}
    \caption{Monte Carlo error scaling on real-world fitted curves.}
    \label{fig:real_world_error_scaling}
\end{figure}
